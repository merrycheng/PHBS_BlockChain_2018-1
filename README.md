...
What is needed is a safe operating environment into which files’ reproduction and distribution is restricted to the owner of the file. Thus, owners would be able to safely duplicate, distribute, control and monetize the file over the internet. By encrypting each file with a unique and brute-force resistant password safely kept into a decentralized public ledger prior any p2p transfer to a file’s final recipient, 2PS propose a solution to address this problem. 
