...
What is really needed is a safe operating environment into which files’ reproduction and distribution is controlled and restricted by their owner. Thus, owners would be able to safely duplicate, distribute, and monetize their files on the web. By encrypting each file with a unique and brute-force resistant password safely kept into a decentralized public ledger prior any p2p transfer to a file’s final recipient, 2PS propose a solution to address this problem. 
...
Building a trusted, decentralized and blockchain-enabled authentication protocol, able to verify that the user has legitimate rights over a file before being able to play and/or open it, would consequently be answering some of those problems. 2PS is aiming to address these issues.
